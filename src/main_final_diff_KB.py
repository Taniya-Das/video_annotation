...
def main(args):
    ...
    if args.VG:
        ...
        if args.dataset == 'MSVD':
            ...
            build_LR_dataset(3, train_dl, encoder, dataset_dict, attribute_stats, relationship_stats, sub_count_c, sub_count_r, args.i3d, 'train')
            build_LR_dataset(3, val_dl, encoder, dataset_dict, attribute_stats, relationship_stats, sub_count_c, sub_count_r, args.i3d, 'val')
            build_LR_dataset(3, test_dl, encoder, dataset_dict, attribute_stats, relationship_stats, sub_count_c, sub_count_r, args.i3d, 'test')

            LR_datapath = '../data/train_LR/MSVD/epoch3' 

            print("Loading VG statistics")        
            with open('msrvtt_attribute_dict.pickle', 'rb') as handle:
                attribute_stats = pickle.load(handle)
            with open('msrvtt_relationship_dict.pickle', 'rb') as handle:
                relationship_stats = pickle.load(handle)
            with open('msrvtt_sub_count_c.pickle', 'rb') as handle:
                sub_count_c = pickle.load(handle)
            with open('msrvtt_sub_count_r.pickle', 'rb') as handle:
            ...
            print("Loading VG statistics")        
            with open('msvd_attribute_dict.pickle', 'rb') as handle:
                attribute_stats = pickle.load(handle)
            with open('msvd_relationship_dict.pickle', 'rb') as handle:
                relationship_stats = pickle.load(handle)
            with open('msvd_sub_count_c.pickle', 'rb') as handle:
                sub_count_c = pickle.load(handle)
            with open('msvd_sub_count_r.pickle', 'rb') as handle:
                sub_count_r = pickle.load(handle)
            ...
            LR_datapath = '../data/train_LR/MSRVTT/epoch3' 
            model = train_LR(LR_datapath)
            coeff = model.coef_
            print("Model Weights :",coeff)
